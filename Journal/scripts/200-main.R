...
## --- FILE 200-main.R: INSTALL AND LOAD PACKAGES, RUN ALL OTHER '200' FILES ---

## packages to be installed from cran
from.cran <- c("biscale", "cowplot", "data.table",  
               "ggsci", "gt", "gtsummary", 
               "here", "officer", "paletteer",  
               "rmarkdown", "terra", "rnaturalearth", 
               "rnaturalearthdata", "rvg", "scales", 
               "sf", "sp", "tidyverse", "viridis")
...
mnm_data <-  
  read_csv(here::here("tmp", "meta-results_150724.csv")) %>% 
