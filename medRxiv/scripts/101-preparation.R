...
data <- read_csv(here::here("data", "mnm-extraction_220224.csv"))

## 1. adjust deliveries and admissions which are not live births by stillbirths and multiple births
## load stillbirth data from UNICEF and convert to long format
stillbirth <- read_xlsx(here::here("data", "stillbirth-rate-and-stillbirths_2023.xlsx"),
...
multiplebirth <- read_xlsx(here::here("data", "twin-rate_monden-2021.xlsx"))
...
## - if institutional delivery / stillbirth data unavailable, assume no need to adjust (high-income countries)
...
## assume institutional deliver rate = 1 if missing
data_adjust_pop <- 
  data_adjust_pop %>% 
