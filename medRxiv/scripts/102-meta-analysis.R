...
##   within a country
## - weights: proportional to sample size so that for a given sample size, low prevalence studies  
##   contribute an equal weight
...
## 2. sensitivity: denominators adjusted only for stillbirth if not live births
...
## 3. merge data sets to compare adjusted and unadjusted results 
...
## save environment
write_csv(meta_analysis, file = here::here("tmp", "meta-results_110324.csv"))
